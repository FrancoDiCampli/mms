                ...
                <section class="mb-8 mt-3">
                    <div class="container px-3 md:px-6">
                        <div class="w-full flex items-center">
                            <p class="text-text-500 text-lg font-medium w-full border-b-2 border-primary-100">Datos del Paciente</p>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mt-5">    
                            <div class="">
                                ...
                                <input class="input-base" placeholder="DNI del paciente" id="dni" name="dni" value="{{ old('dni') }}">
                                @error('dni')
                            ...
                            <div class="">
                                ...
                                <Select class="input-base" placeholder="Obra social" id="social_work_id" name="social_work_id" value="{{ old('social_work_id') }}">
                            ...
                            <div class="">
                                ...
                                <input class="input-base" placeholder="N° de afiliado" id="num_affiliate" name="num_affiliate" value="{{ old('num_affiliate') }}">
                                @error('num_affiliate')
                                <span class="text-red-500">{{$message}}</span>
                                @enderror
                            </div>       
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mt-4">
                            <div class="">
                                ...
                                <input class="input-base" placeholder="Apellido del paciente" id="surname" name="surname" value="{{ old('surname') }}">
                                @error('surname')
                                    <span class="text-red-500">{{$message}}</span>
                                @enderror
                            </div>  
                            ...
                            <div class="">
                                ...
                                <input class="input-base" placeholder="Nombre del paciente" id="name" name="name" value="{{ old('name') }}">
                                @error('name')
                                    <span class="text-red-500">{{$message}}</span>
                                @enderror
                            </div>
                            ...
                            <div class="">
                                ...
                                <input class="input-base" placeholder="Teléfono del paciente" id="phone" name="phone" value="{{ old('phone') }}">
                                @error('phone')
                                    <span class="text-red-500">{{$message}}</span>
                                @enderror
                            </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
                            <div class="">
                                ...
                                <input class="input-base" id="fnac" name="fnac" type="date" max="{{now()->format('Y-m-d')}}" value="{{old('fnac')}}" onchange="calcularEdad(value)">
                                @error('fnac')
                                    <span class="text-red-500">{{$message}}</span>
                                @enderror
                            </div>  
                            ...
                            <div class="">
                                ...
                                <input class="input-base cursor-not-allowed" placeholder="Edad" id="age" name="age" value="{{old('age')}}" disabled>
                                @error('age')
                                    <span class="text-red-500">{{$message}}</span>
                                @enderror
                            </div>
                    ...
                    <div class="container px-3 md:px-6">
                        ...
                        <div class="grid grid-cols-1 gap-4 mt-5">    
                            <div class="">
                                ...
                                <input class="input-base" placeholder="Dirección del paciente" id="address" name="address" value="{{ old('address') }}">
                                @error('address')
                                    <span class="text-red-500">{{$message}}</span>
                                @enderror
                            </div>  
                        ...
                        <div class="w-full mt-5">       
                            <div class="w-full md:flex items-center">
                                <div class="w-full md:mx-2">
                                    ...
                                    <textarea cols="30" rows="2" class="input-base" placeholder="Antecedentes médico del paciente"
                                    name="ant_medical" id="ant_medical">{{ old('ant_medical') }}</textarea>
                                    @error('ant_medical')
                                        <span class="text-red-500">{{$message}}</span>
                                    @enderror
                                </div>                
                            ...
                            <div class="w-full md:flex items-center">
                                <div class="mt-5  w-full md:mx-2">
                                    ...
                                    <textarea cols="30" rows="2" class="input-base" placeholder="Antecedentes quirúrgico del paciente"
                                    name="ant_surgical" id="ant_surgical" value="{{ old('ant_surgical') }}"></textarea>
                                    @error('ant_surgical')
                                        <span class="text-red-500">{{$message}}</span>
                                    @enderror
                                </div>                
