...
<div class="shadow overflow-hidden sm:rounded-md">
    <div class="px-4 py-5 bg-white sm:p-6">
        <div class="grid grid-cols-6 gap-6">
            ...
            <div class="col-span-6 sm:col-span-3">
                <label for="social_works" class="block text-sm font-medium leading-5 text-gray-700">Obra Social</label>
                @foreach ($socialworks as $item)
                <ul>
                    <li>
                        <div class="flex justify-start items-center">
                            <input type="checkbox" name="social_works[{{$item->id}}][id]" id="box.{{$item->id}}"
                                value="{{$item->id}}">{{$item->name}}
                            @if ($item->id <> 1)
                                <input type="number" name="social_works[{{$item->id}}][afiliado]"
            ...
            <div class="col-span-6 sm:col-span-3">
                <label for="surname" class="block text-sm font-medium leading-5 text-gray-700">Apellido</label>
            ...
            <div class="col-span-6 sm:col-span-3">
                <label for="age" class="block text-sm font-medium leading-5 text-gray-700">Edad</label>
            ...
            <div class="col-span-6 sm:col-span-3">
                <label for="city" class="block text-sm font-medium leading-5 text-gray-700">Localidad</label>
            ...
            <div class="col-span-6 sm:col-span-3">
                <label for="province" class="block text-sm font-medium leading-5 text-gray-700">Provincia</label>
            ...
            <div class="col-span-6">
                <label for="ant_medical" class="block text-sm font-medium leading-5 text-gray-700">Antecedentes
                    Médicos</label>
            ...
            <div class="col-span-6">
                <label for="ant_surgical" class="block text-sm font-medium leading-5 text-gray-700">Antecedentes
                    Quirúrgicos</label>
