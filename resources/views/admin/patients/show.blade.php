...
<div class="card">
    ...
    <div x-data="{selected:null}">
        ...
        <div class="grid md:grid-cols-5 gap-4 mt-3 px-2">
            ...
            <div class="">
                ...
                <p class="text-text-400 text-base font-normal">
                    {{$patient->fnac ? $patient->fnac->format('d/m/Y') : null}}</p>
            </div>
            <div class="">
        ...
        <div x-show="selected == 0" x-transition:enter="transition ease-out duration-200"
            ...
            <div class="w-full p-2">
                <div class="">
                    ...
                    <p class="text-text-400 text-base font-normal">Lorem ipsum dolor sit amet consectetur adipisicing
                        elit. Atque delectus corporis velit earum minima illum culpa, suscipit nisi voluptates optio!
                    </p>
                </div>
            </div>
        </div>
        ...
        {{-- Antecedentes --}}
        <div class="grid md:grid-cols-2 gap-4 mt-2 border-t pt-4 items-center">
            <form action="{{route('patients.updateAntecedentes', $patient->id)}}" method="POST"
                enctype="multipart/form-data" onsubmit="updateAnt.disabled = true;">
                @method('PUT')
                @csrf
                <div class="">
                    ...
                    <div class="mt-2 m-1">
                        <textarea name="ant_medical" id="ant_medical" cols="30" rows="3" class="input-base"
                            placeholder="Ingresar los datos antecedentes médicos">{{$patient->ant_medical}}</textarea>
                        @error('ant_medical')
                ...
                <div class="">
                    ...
                    <div class="mt-2 m-1">
                        <textarea name="ant_surgical" id="ant_surgical" cols="30" rows="3" class="input-base"
                            placeholder="Ingresar los datos de antecedentes quirúrgicos">{{$patient->ant_surgical}}</textarea>
                        @error('ant_surgical')
                        <span class="text-red-500">{{$message}}</span>
                        @enderror
                    </div>
                ...
                <div class="px-1 w-full text-right mt-3 md:mt-2">
                    <button id="updateAnt" class="w-full md:w-auto btn btn-primary" type="submit">
...
<div class="card">
    ...
    <form action="{{route('queries.store')}}" method="POST" enctype="multipart/form-data"
        onsubmit="storeQuery.disabled = true;">
        @csrf
        ...
        <div class="px-1 w-full text-right mt-3 md:mt-2">
            <button id="storeQuery" class="w-full md:w-auto btn btn-primary" type="submit">
                <svg class="w-5 h-5 mr-1 hidden md:inline-block" xmlns="http://www.w3.org/2000/svg" fill="none"
                    viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
