                                ...
                                <div class="col-span-6 sm:col-span-3">
                                    ...
                                    <table>
                                        <tbody>
                                            ...
                                            <td>
                                                <input wire:model.defer="num_afiliado" type="text" name="" id=""
                                                    placeholder="Nº Afiliado" class="mt-1 form-input block w-full py-2 px-3 border border-gray-300 rounded-md shadow-sm
                                                focus:outline-none focus:shadow-outline-blue focus:border-blue-300 transition duration-150 ease-in-out
                                                sm:text-sm sm:leading-5">
                                            </td>
                                            <td>
                                                <button wire:click="agregar({{$item}})" type="button"
                                                    class="py-2 px-4 border border-transparent text-sm leading-5 font-medium rounded-md text-white bg-indigo-600 shadow-sm hover:bg-indigo-500 focus:outline-none focus:shadow-outline-blue active:bg-indigo-600 transition duration-150 ease-in-out">+</button>
                                            </td>
                                        </tbody>
                                    </table>
                                    @error('social_works')
                                    ...
                                    <span class="text-xs text-black bg-indigo-100 m-1 p-1">{{$item['id']}} -
                                        {{$item['affiliate']}}</span>
                                    @endforeach
                                </div>
