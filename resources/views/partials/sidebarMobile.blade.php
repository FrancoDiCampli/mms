<div x-show="sidebarOpen" x-transition:enter="transition ease-out duration-100"
    ...
    class="fixed z-40 inset-y-0 left-0 w-64 transition duration-300 transform bg-white overflow-y-auto lg:translate-x-0 lg:static lg:inset-0 h-screen shadow-lg">
    <div class="flex items-center justify-start px-6 mt-20 text-green-300">
        <svg aria-hidden="true" data-prefix="fas" data-icon="laptop-medical"
            class="svg-inline--fa fa-laptop-medical fa-w-20 w-8 h-8" xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 640 512">
    ...
    <nav class="mt-8">
        <a class="flex items-center mt-4 py-2 px-6 bg-gray-300 bg-opacity-25 text-gray-900 border-r-4 border-gray-600"
            href="/dashboard">
        ...
        <a class="flex items-center mt-4 py-2 px-6 text-gray-500 hover:bg-gray-700 hover:bg-opacity-25 hover:text-gray-100"
            ...
            <svg aria-hidden="true" data-prefix="fas" data-icon="stethoscope"
                class="svg-inline--fa fa-stethoscope fa-w-16 h-6 w-6 hover:text-green-500"
        ...
        <a class="flex items-center mt-4 py-2 px-6 text-gray-500 hover:bg-gray-700 hover:bg-opacity-25 hover:text-gray-100"
            ...
            <svg aria-hidden="true" data-prefix="fas" data-icon="user-md"
                class="svg-inline--fa fa-user-md fa-w-14 h-6 w-6 hover:text-green-500"
